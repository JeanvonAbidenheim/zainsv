...
import { initTheme, setStatStripValues, initLoader } from "./theme.js";
...
function typeRole() {
  ...
  if (!deleting) {
    ...
    if (charIdx === role.length) { deleting = true; return setTimeout(typeRole, 2000); }
  } else {
    el.textContent = role.slice(0, --charIdx);
...
export async function initApp() {
  ...
  // 2. Start all theme interactions
  initTheme();
