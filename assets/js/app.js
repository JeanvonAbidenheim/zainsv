...
import { initWayang, setStatStripValues } from "./wayang.js";
...
function initNavbar() {
  ...
  // Close mobile menu on link click (toggle button itself is handled in wayang.js initMobileNav)
...
export async function initApp() {
  typeRole();
  initWayang();   // 🎭 Mega menu, stat counter, motif batik halus
  initNavbar();
  initReveal();
